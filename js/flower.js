...
function init()
{
    ...
    /*获取对将包含叶的元素的引用*/
    var container = document.getElementById('flowerContainer');
    /* Fill the empty container with new leaves */
    /*用新叶子把空容器装满*/
    for (var i = 0; i < NUMBER_OF_FLOWER; i++)
    {
...
function createALeaf()
{
    ...
    将照片放到这里 有四张的话 就写5*/
    image.src = 'images/spring/flower' + randomInteger(1, 5) + '.png';

    leafDiv.style.top = "-100px";

    /* Position the leaf at a random location along the screen
    将叶沿屏幕随机放置　　写真のサイズ 　例えば１０２４px（０，１０２４）*/
    leafDiv.style.left = pixelValue(randomInteger(0, 1280));
